...
public class AppManager {
    private static String LOG = AppManager.class.getSimpleName();
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                ...
                for (UserHandle userHandle : profiles) {
                    ...
                    for (LauncherActivityInfo info : apps) {
                        ...
                        Log.d(LOG, String.format("adding work profile to non filtered list: %s, %s, %s", app._label, app._packageName, app._className));
                ...
                for (ResolveInfo info : activitiesInfo) {
                    ...
                    Log.d(LOG, String.format("adding app to non filtered list: %s, %s, %s", app._label,  app._packageName, app._className));
                    nonFilteredAppsTemp.add(app);
                }
            }
